...
var tinyPriv = PrivateKey{
	PublicKey: PublicKey{
		...
		Y: fromHex(""),
	},
	X: fromHex("1"),
}

func TestSignAndVerify(t *testing.T) {
	testSignAndVerify(t, 0, &testPriv)
}

func TestSignWithTinyKeys(t *testing.T) {
	testSignAndVerify(t, 0, &tinyPriv)
}
...
func benchVerify(b *testing.B, priv *PrivateKey) {
	hashed := []byte("testing")
	r, s, err := Sign(rand.Reader, priv, hashed)
	if err != nil {
		b.Errorf("error signing: %s", err)
